...
add_hook allows us to register a function node, in this case various optimiser functions, to an object. Here both adam and vanilla SGD are 'hooked' to the optimiser. Also, gradients passed to the optimiser are clipped with a threshold of 5. Gradient clipping limits the size of weight updates suppressing the weight updates from overshooting the landscape minimum.
'''
